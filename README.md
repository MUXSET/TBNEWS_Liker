...
### v2.2.0 (2026-03-11) — 全新品牌 & 实用功能升级
- 🏷️ **品牌焕新**：正式更名为「TBE+ 阅赞助手」，从单纯的点赞工具进化为更智能的阅读打卡平台。
- 🌐 **网络互通性突破**：新增「强制直连绕过代理」选项，彻底解决深信服 / IP-Guard 等企业终端内网审计软件引发的 `WinError 10013` 连接重置及 SSL 拦截报错，实现复杂内网自由挂机。
